            ...
            <main class="manifesto-wrapper">
                ...
                <section>
                    ...
                    <div class="image-frame">
                        <img loading="lazy" src="img/testes/base-renda-passiva.webp" alt="[Mapa da Base Recomendada]" class="base-image" onerror="this.src='https://via.placeholder.com/800x450?text=Imagem+da+Base+Nao+Encontrada'">
