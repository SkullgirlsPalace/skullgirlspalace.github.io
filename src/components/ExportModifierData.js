  ...
  <div id="modifier-export-modal-overlay" class="export-modal-overlay" onclick="handleModifierExportOverlayClick(event)">
    <div class="export-modal" onclick="event.stopPropagation()">
      <div class="export-modal-header">
        <h2>\uD83D\uDCE5 ${t('export.modifiers')}</h2>
        <button class="export-modal-close" onclick="toggleModifierExportModal()" aria-label="${t('export.close')}">\u2715</button>
      </div>
      ...
      <div class="export-modal-body">
        ...
        <div class="export-controls">
          ...
          <span class="export-count" id="modifier-export-selected-count">0 ${t('export.selectedPlural')}</span>
        </div>
...
function downloadModifierTXT(modifierData, keys) {
  ...
  lines.push('\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550');
  lines.push(` ${t('export.modifiersData')}`);
  lines.push('\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550');
  lines.push('');
  ...
  if (buffs.length > 0) {
    lines.push('\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557');
    lines.push(`\u2551 ${t('export.buffsHeader')}`);
    lines.push('\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D');
    lines.push('');
    ...
    for (const key of buffs) {
      ...
      lines.push(`  ${t('export.type')}: ${t('export.positiveType')}`);
      lines.push(`  ${t('export.description')}: ${effect.detailed}`);
      if (effect.stacks) lines.push(`  ${t('export.maxStacks')}: ${effect.stacks}x`);
      if (effect.scaling) lines.push(`  ${t('export.scaling')}: ${effect.scaling}`);
      if (effect.keys) lines.push(`  ${t('export.keywords')}: ${effect.keys.join(', ')}`);
      lines.push('');
    }
  }
  ...
  if (debuffs.length > 0) {
    lines.push('\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557');
    lines.push(`\u2551 ${t('export.debuffsHeader')}`);
    lines.push('\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D');
    lines.push('');
    ...
    for (const key of debuffs) {
      const effect = modifierData[key];
      lines.push(`  \u2605 ${effect.name}`);
      lines.push(`  ${t('export.type')}: ${t('export.negativeType')}`);
      lines.push(`  ${t('export.description')}: ${effect.detailed}`);
      if (effect.stacks) lines.push(`  ${t('export.maxStacks')}: ${effect.stacks}x`);
      if (effect.scaling) lines.push(`  ${t('export.scaling')}: ${effect.scaling}`);
      if (effect.keys) lines.push(`  ${t('export.keywords')}: ${effect.keys.join(', ')}`);
