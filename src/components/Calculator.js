    ...
    return `
        <div class="calculator-box">
            ...
            <div class="calc-tab-bar">
                <button class="calc-tab active" data-tab="ganhos" onclick="switchCalcTab('ganhos')"><img loading="lazy" src="img/official/CanopyCoin.webp" style="height: 1.8em; vertical-align: -0.4em; margin-right: 0.2rem;" alt="Moedas"> Ganhos Mensais</button>
                ...
                <div class="calc-layout">
                        ...
                        <div class="calc-form">
                            ...
                            <div class="calc-section">
                                ...
                                <div class="toggle-group exclusive" id="dp-faixa-toggles">
                                    <button class="toggle-btn" data-source="bronze" data-type="dpFaixa"><img loading="lazy" src="img/official/icone_bronze.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Bronze"> Bronze</button>
                                    <button class="toggle-btn" data-source="prata" data-type="dpFaixa"><img loading="lazy" src="img/official/icone_prata.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Prata"> Prata</button>
                                    <button class="toggle-btn" data-source="ouro" data-type="dpFaixa"><img loading="lazy" src="img/official/icone_ouro.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Ouro"> Ouro</button>
                                    <button class="toggle-btn active" data-source="diamante" data-type="dpFaixa"><img loading="lazy" src="img/official/icone_diamante.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Diamante"> Diamante</button>
                            ...
                            <div class="calc-section">
                                ...
                                <div class="toggle-group exclusive" id="guilda-tier-toggles">
                                    <button class="toggle-btn" data-source="bronze" data-type="guildaTier"><img loading="lazy" src="img/official/icone_bronze.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Bronze"> Bronze</button>
                                    <button class="toggle-btn" data-source="prata" data-type="guildaTier"><img loading="lazy" src="img/official/icone_prata.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Prata"> Prata</button>
                                    <button class="toggle-btn" data-source="ouro" data-type="guildaTier"><img loading="lazy" src="img/official/icone_ouro.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Ouro"> Ouro</button>
                                    <button class="toggle-btn active" data-source="diamante" data-type="guildaTier"><img loading="lazy" src="img/official/icone_diamante.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Diamante"> Diamante</button>
                    ...
                    <div class="calc-results">
                        <div id="earnings-result" class="result-box">
                            <h4><img loading="lazy" src="img/official/Theonite.webp" style="height: 1.8em; vertical-align: -0.4em; margin-right: 0.2rem;" alt="Teonita"> Resultado Estimado</h4>
                ...
                <div class="calc-layout">
                        ...
                        <div class="calc-form">
                            ...
                            <div class="calc-section">
                                ...
                                <div class="toggle-group exclusive" id="golpe-raridade-toggles">
                                    <button class="toggle-btn" data-source="bronze" data-type="golpeRaridade"><img loading="lazy" src="img/official/icone_bronze.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Bronze"> Bronze</button>
                                    <button class="toggle-btn" data-source="prata" data-type="golpeRaridade"><img loading="lazy" src="img/official/icone_prata.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Prata"> Prata</button>
                                    <button class="toggle-btn" data-source="ouro" data-type="golpeRaridade"><img loading="lazy" src="img/official/icone_ouro.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Ouro"> Ouro</button>
                                    <button class="toggle-btn active" data-source="diamante" data-type="golpeRaridade"><img loading="lazy" src="img/official/icone_diamante.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Diamante"> Diamante</button>
                            ...
                            <div class="calc-section">
                                ...
                                <div class="toggle-group exclusive" id="astro-raridade-toggles">
                                    <button class="toggle-btn" data-source="bronze" data-type="astroRaridade"><img loading="lazy" src="img/official/icone_bronze.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Bronze"> Bronze (Lv 5)</button>
                                    <button class="toggle-btn" data-source="prata" data-type="astroRaridade"><img loading="lazy" src="img/official/icone_prata.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Prata"> Prata (Lv 10)</button>
                                    <button class="toggle-btn" data-source="ouro" data-type="astroRaridade"><img loading="lazy" src="img/official/icone_ouro.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Ouro"> Ouro (Lv 15)</button>
                                    <button class="toggle-btn active" data-source="diamante" data-type="astroRaridade"><img loading="lazy" src="img/official/icone_diamante.webp" style="height: 1.2em; vertical-align: -0.2em; margin-right: 0.2rem;" alt="Diamante"> Diamante (Lv 20)</button>
                    ...
                    <div class="calc-results">
                        <div id="build-cost-result" class="result-box">
                            <h4><img loading="lazy" src="img/official/CanopyCoin.webp" style="height: 1.8em; vertical-align: -0.4em; margin-right: 0.2rem;" alt="Moedas"> Custo Total da Build</h4>
...
export function calculateBuildCost() {
    ...
    html += `
        <div class="cost-total">
            <div class="total-row">
                <span class="total-label"><img loading="lazy" src="img/official/CanopyCoin.webp" style="height: 1.8em; vertical-align: -0.4em; margin-right: 0.2rem;" alt="Moedas"> Total em Moedas</span>
